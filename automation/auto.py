...
if __name__ == '__main__':
    ...
    # for name in tqdm(code_names, desc="code to flowchart", file=sys.stdout):
    ...
    # # pid = []
    # flow_names1 = flow_names[:]
    # for name in tqdm(flow_names1, desc="flowchart to svg"):

    #     # with popen
    #     # pid.append(subprocess.Popen(
    #     #     ["diagrams", "flowchart", f"./flnowchart/{name}.flowchart", f"./svg/{name}.svg"],
    ...
    # svg_names = [i[:-4] for i in os.listdir('./svg') if i.endswith('.svg')]
    # svg_names1 = svg_names[10000:]
    # for name in tqdm(svg_names1, desc="svg to png"):
    #     svg_to_png(name)
